  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Link to={"/new/application/form"}><Button size={"massive"}>via Form</Button></Link>
        <Link to={"/new/application/json"}><Button size={"massive"}>via JSON</Button></Link>
        <Link to={"/new/application/file"}><Button size={"massive"}>via File upload</Button></Link>
